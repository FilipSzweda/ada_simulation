...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#e11cb741#;
   ...
   u00155 : constant Version_32 := 16#34d15b20#;
   pragma Export (C, u00155, "buforB");
   u00156 : constant Version_32 := 16#2ae8fd16#;
   pragma Export (C, u00156, "buforS");
   ...
   u00169 : constant Version_32 := 16#0c334715#;
   pragma Export (C, u00169, "system__task_primitivesS");
   u00170 : constant Version_32 := 16#4e3ebb7e#;
   pragma Export (C, u00170, "system__os_interfaceS");
   u00171 : constant Version_32 := 16#0039537b#;
   pragma Export (C, u00171, "interfaces__c__stringsB");
   u00172 : constant Version_32 := 16#eda3d306#;
   pragma Export (C, u00172, "interfaces__c__stringsS");
   u00173 : constant Version_32 := 16#cc709166#;
   pragma Export (C, u00173, "system__task_primitives__operationsB");
   u00174 : constant Version_32 := 16#9723968e#;
   ...
   u00176 : constant Version_32 := 16#cf061228#;
   pragma Export (C, u00176, "system__float_controlS");
   u00177 : constant Version_32 := 16#6387a759#;
   pragma Export (C, u00177, "system__interrupt_managementB");
   u00178 : constant Version_32 := 16#26aedc33#;
   pragma Export (C, u00178, "system__interrupt_managementS");
   u00179 : constant Version_32 := 16#7bca5a8d#;
   pragma Export (C, u00179, "system__multiprocessorsB");
   u00180 : constant Version_32 := 16#1756ce67#;
   pragma Export (C, u00180, "system__multiprocessorsS");
   u00181 : constant Version_32 := 16#24ec69e6#;
   pragma Export (C, u00181, "system__os_primitivesB");
   u00182 : constant Version_32 := 16#280734e2#;
   pragma Export (C, u00182, "system__os_primitivesS");
   u00183 : constant Version_32 := 16#2f9cb76c#;
   pragma Export (C, u00183, "system__arith_64B");
   u00184 : constant Version_32 := 16#9d9eabfb#;
   pragma Export (C, u00184, "system__arith_64S");
   u00185 : constant Version_32 := 16#05c60a38#;
   pragma Export (C, u00185, "system__task_lockB");
   u00186 : constant Version_32 := 16#4e70667a#;
   pragma Export (C, u00186, "system__task_lockS");
   u00187 : constant Version_32 := 16#b8c476a4#;
   pragma Export (C, u00187, "system__win32__extS");
   u00188 : constant Version_32 := 16#ce7dfb56#;
   pragma Export (C, u00188, "system__task_infoB");
   u00189 : constant Version_32 := 16#5a49699d#;
   pragma Export (C, u00189, "system__task_infoS");
   ...
   u00194 : constant Version_32 := 16#4ddebf0b#;
   pragma Export (C, u00194, "system__tasking__debugB");
   u00195 : constant Version_32 := 16#d3b35c55#;
   pragma Export (C, u00195, "system__tasking__debugS");
   u00196 : constant Version_32 := 16#886988be#;
   ...
   u00198 : constant Version_32 := 16#d499f4ac#;
   ...
   u00200 : constant Version_32 := 16#2e7731ce#;
   ...
   u00203 : constant Version_32 := 16#5ca174ae#;
   ...
   u00206 : constant Version_32 := 16#ac06ab59#;
   ...
   u00208 : constant Version_32 := 16#d5216b8e#;
   ...
   u00214 : constant Version_32 := 16#acbd1abf#;
   pragma Export (C, u00214, "system__tasking__utilitiesB");
   u00215 : constant Version_32 := 16#6b757be7#;
   ...
   u00218 : constant Version_32 := 16#91809229#;
   pragma Export (C, u00218, "ada__real_timeB");
   u00219 : constant Version_32 := 16#1ad7dfc0#;
   pragma Export (C, u00219, "ada__real_timeS");
   u00220 : constant Version_32 := 16#ca8c282d#;
   pragma Export (C, u00220, "system__finalization_mastersB");
   u00221 : constant Version_32 := 16#4e386d0b#;
   pragma Export (C, u00221, "system__finalization_mastersS");
   u00222 : constant Version_32 := 16#35d6ef80#;
   pragma Export (C, u00222, "system__storage_poolsB");
   u00223 : constant Version_32 := 16#548cb6a3#;
   pragma Export (C, u00223, "system__storage_poolsS");
   u00224 : constant Version_32 := 16#f2cb0106#;
   pragma Export (C, u00224, "konsumentB");
   u00225 : constant Version_32 := 16#b7f25634#;
   pragma Export (C, u00225, "konsumentS");
   u00226 : constant Version_32 := 16#ffaa9e94#;
   pragma Export (C, u00226, "ada__calendar__delaysB");
   u00227 : constant Version_32 := 16#d86d2f1d#;
   pragma Export (C, u00227, "ada__calendar__delaysS");
   u00228 : constant Version_32 := 16#48583e4e#;
   pragma Export (C, u00228, "ada__calendarB");
   u00229 : constant Version_32 := 16#31350a81#;
   pragma Export (C, u00229, "ada__calendarS");
   u00230 : constant Version_32 := 16#0774605b#;
   pragma Export (C, u00230, "system__random_numbersB");
   u00231 : constant Version_32 := 16#19a1600c#;
   pragma Export (C, u00231, "system__random_numbersS");
   u00232 : constant Version_32 := 16#15692802#;
   pragma Export (C, u00232, "system__random_seedB");
   u00233 : constant Version_32 := 16#c3b30278#;
   pragma Export (C, u00233, "system__random_seedS");
   u00234 : constant Version_32 := 16#282e0953#;
   pragma Export (C, u00234, "producentB");
   u00235 : constant Version_32 := 16#897e2947#;
   pragma Export (C, u00235, "producentS");
   u00236 : constant Version_32 := 16#eca5ecae#;
   pragma Export (C, u00236, "system__memoryB");
   u00237 : constant Version_32 := 16#76873720#;
   pragma Export (C, u00237, "system__memoryS");
